...
function getCadastros(nome) {
    ...
    fetch('http://127.0.0.1:3000/medicamento' + parametro,
        {
            method: "GET",
...
function getCadastro(id) {
    abrirLoading()
    fetch("http://127.0.0.1:3000/medicamento/" + id,
        {
            method: "GET",
            headers: { 'Content-Type': 'application/json' },
        })
...
function postPutCadastro(obj, id) {
    ...
    let endereco = "http://127.0.0.1:3000/medicamento";
    let metodo = "POST";
    if (id) {
        endereco = "http://127.0.0.1:3000/medicamento/" + id;
        metodo = "PUT";
    }
    fetch(endereco,
        {
